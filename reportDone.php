...
$detail = isset($_GET['detail']) ? $_GET['detail'] : 'No detail provided';
?>
...
<body>
  <?php
    include('head.php');
  ?>
  <a class="back-btn" href="reportDetails.php">&larr; Back</a>
  <h1>Report Notes</h1>
  <section class="report-box">
    <h3 class="report-type"><b>Report type :</b><br><?php echo htmlspecialchars($reportType); ?></h3>
    <h3 class="report-type"><b>Report detail :</b><br><?php echo htmlspecialchars($detail); ?></h3>
