...
<body>
  ...
  <ul class="list-report">
    <li><a href="reportDetails.php?report_type=Inappropriate Language&note_ID=<?= $noteID ?>&<?= $backQuery ?>">1. Inappropriate Language</a></li>
    <li><a href="reportDetails.php?report_type=Harassment or Bullying&note_ID=<?= $noteID ?>&<?= $backQuery ?>">2. Harassment or Bullying</a></li>
    <li><a href="reportDetails.php?report_type=Irrelevant or Spam Content&note_ID=<?= $noteID ?>&<?= $backQuery ?>">3. Irrelevant or Spam Content</a></li>
    <li><a href="reportDetails.php?report_type=Plagiarized or Copyrighted Material&note_ID=<?= $noteID ?>&<?= $backQuery ?>">4. Plagiarized or Copyrighted Material</a></li>
  </ul>
